...
public class ObjectLibrary {
    ...
    public static function getRedrawnTextureFromType(_arg_1:int, _arg_2:int, _arg_3:Boolean, _arg_4:Boolean = true, _arg_5:Number = 5):BitmapData {
        ...
        }else if(_local_8 == null && _local_9.hasOwnProperty("Void")) {
            return (TextureRedrawer.redraw(_local_6, _arg_2, _arg_3, 0x7B78C4, _arg_4, _arg_5));
        }else if(_local_8 == null && _local_9.hasOwnProperty("Forsaken")) {
            return (TextureRedrawer.redraw(_local_6, _arg_2, _arg_3, 0xBDA499, _arg_4, _arg_5));
