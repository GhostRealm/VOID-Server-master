...
public class StatMetersView extends Sprite {
    ...
    public function StatMetersView() {
        ...
        this.fameBar_ = new StatusBar(176, barSize, 0x7302E8, 0x545454, TextKey.CURRENCY_FAME);
        this.hpBar_ = new StatusBar(176, barSize, 0xEA0000, 0x545454, TextKey.STATUS_BAR_HEALTH_POINTS);
        this.mpBar_ = new StatusBar(176, barSize, 0x002AFF, 0x545454, TextKey.STATUS_BAR_MANA_POINTS);
        this.surgeBar_ = new StatusBar(176 / 2 - 2, barSize, 0xFFB089, 0x545454, "PW");
        this.protectionBar = new StatusBar(176 / 2 - 2, barSize, 0xFFFFFF, 0x545454, "FTH");
